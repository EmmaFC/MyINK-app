...
<div class="column container-second">
    <div class="d-flex justify-content-start"><h1 class="section-title-dark">{{ __('Form Libro') }}</h1></div>
      <div class="box">
            ...
            <form action="{{ url('/book') }}" method="post" enctype="multipart/form-data"{{-- archivos tipo img --}}>
              ...
              <div class="container-second">
                  ...
                  <div class="container-second mt-4 mb-4 d-flex justify-content-between align-content-center">
                      <a href="{{ route('book') }}"><h4 class="text-link-dark">Volver</h4></a>
                      <a href="{{ route('book') }}"><h4 class="text-link-dark">Guardar</h4></a>
                  </div>
             </div>
           </form>
        </div>
