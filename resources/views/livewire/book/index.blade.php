    ...
    <table class="table table-bordered"> 
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><a href=" {{ route('book.edit', ['book' => $book->id]) }} "><button class="btn" name="edit_book" label="edit_book" type="submit">Edit</button></a></td>
               <td>
                  <form action="{{ route('book.destroy', ['book' => $book->id]) }}" method="post"></form>
                  @csrf
                  {{ method_field('DELETE') }}
                  
                  <a href="#"><button class="btn" name="delete_book" label="delete_book" type="submit" onclick="return confirm('¿Estás seguro de que quieres borrar este libro?')">Delete</button></a>
               </td>
             </tr>
             @endforeach
         </tbody>
